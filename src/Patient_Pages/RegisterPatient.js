...
const RegistrationFormPat = ({navigation}) => {
...
const handleNextSlide = () => {
  if (currentinfosIndex <= informations.length - 1) {
    ...
    const handleSignup = () => {
      if(create_password != confirm_password ) {
        ...
        }else if (!first_name || !last_name || !email || !phone || !create_password || !confirm_password || !address) {
        Alert.alert(
          'Error !!',
          'All Fields Required',
          [
        ...
        fetch("http://"+ServerIP+"/DoctorApp/registerPat.php", {
          method: 'POST',
          headers: {
    ...
    return (
      <LinearGradient colors={['#42E695', '#37C3FF']} style={{width:screenWidth, height: screenHeight+30}}>  
        
        <View style={{borderColor:'#37C3FF', backgroundColor:'rgba(255, 255, 255, 0.5)', borderRadius:screenWidth/20, borderWidth:screenWidth/100, height:screenHeight/2, width:screenWidth/1.1, top:screenHeight/4, marginLeft:screenWidth/20}}>
  ...
  export default RegistrationFormPat;